...
def get_ngram_counts(text, ngram_range=(1, 1)):
    vectorizer = CountVectorizer(ngram_range=ngram_range)
    X = vectorizer.fit_transform(text)
    return X, vectorizer

# Example of extracting unigram (1-gram) counts
x_counts, vectorizer = get_ngram_counts(final_data['text'], ngram_range=(1, 1))

# Optionally, you can print the vocabulary (features) generated by CountVectorizer
